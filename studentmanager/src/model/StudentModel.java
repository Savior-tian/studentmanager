...
public class StudentModel {
	...
	public int insert(Student student){
		return insert(student.getId(), student.getName(), student.getSex(), student.getAge(), student.getGrade(), student.getScore());
	}
	...
	public int batchInsert(List<Student> students){
		...
		try {
			...
			for (Student student : students) {
				...
				statement.setFloat(6, student.getScore());
				statement.addBatch();
			}
			...
			s.closeAll(conn, statement, null);
		}
		return count;
	}
